...
--              {description = "move to screen", group = "client"}),
    ...
    awful.key({ modkey, "Shift"   }, "m",
        function (c)
            ...
            c:raise()tag.connect_signal("property::layout", function(t)
...
--          "Sxiv",
    ...
    -- Rule for picture in picture
    { rule = { name = "Картинка в картинке" },
